---
layout: post
title:  "Notes - Mini Quipu Column for the #DHMakes Mail Art Collaboration"
...
![Quipu Column](/assets/dhmakes_post/01_Quipu_Column.jpg)
...
- [Column](https://gihub.com/JackiePease/QuipuColumn/blob/main/3D_printing_and_laser_cutting_files/DHMakes/column.stl)
...
![Area Yarn Colours](/assets/dhmakes_post/09_area_yarn_colours.jpg)
...
I assigned a colour to each of these categories too (Broadband - Off-White, Large screen devices - Light Green, Smart TV - Red, Total Equipment - Black, Total MDLS - Gold):

![Fail Categories](/assets/dhmakes_post/10_fail_categories.jpg)

I then made a cord for each combination using two strands of crochet cotton for the area and one for the category e.g. 2 strands of Dark Green and one of Red to represent number of households with children in the Wirral who don't have adequate Smart TV access. Here's the type of cotton I used:
...
I only managed to make one complete model - I don't know why I was surprised that a small model, with exactly the same number of twisted cords and knots as a larger version, would take around the same time to build! Maybe it just needs practice - Incas and modern day hair braiders could probably do it quicker.
...
If you've got any sets of data with 5 categories for each of 6 areas (or 6 categories for each of 5 areas) then this column might work for you, but it could also be used as the basis for something else. [This Instagram user's Quipu-inspired interior decoration](https://www.instagram.com/arteunay/) inspires me to try something more freestyle next. And I'd love to know if anyone is inspired by this project.
